...
class CNN_DistributedScanningMLP():
    ...
    def init_weights(self, weights):
        ...
        self.conv1.conv1d_stride1.W = w1[0:48, 0:2].reshape(self.conv1.conv1d_stride1.W.T.shape).T
        self.conv2.conv1d_stride1.W = w2[0:4, 0:8].reshape(self.conv2.conv1d_stride1.W.T.shape).T
        self.conv3.conv1d_stride1.W = w3.reshape(self.conv3.conv1d_stride1.W.T.shape).T
